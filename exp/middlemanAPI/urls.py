...
urlpatterns = [
    ...
    url(r'^transation/(?P<transaction_id>[0-9]+)/$', views.TransactionView, name="TransactionView"),
    ...
    url(r'^review/all/(?P<listing_id>[0-9]+)/', views.AllReviewsView, name="AllReviewsView"),
    url(r'^login/', views.Login, name="Login"),
    url(r'^logout/', views.Logout, name="Logout"),
    url(r'^createaccount', views.CreateAccount, name="CreateAccount"),
    url(r'^authenticate/', views.Authenticate, name="Authenticate"),
    url(r'^search/', views.Search, name="search"),
    url(r'^recordclick/', views.RecordClick, name="RecordClick"),
]
